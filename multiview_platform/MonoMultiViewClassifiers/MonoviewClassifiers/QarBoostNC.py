...
class ColumnGenerationClassifierQarNC(BaseEstimator, ClassifierMixin, BaseBoost):
    def __init__(self, epsilon=1e-06, n_max_iterations=None, estimators_generator=None, dual_constraint_rhs=0, save_iteration_as_hyperparameter_each=None, random_state=42):
        super(ColumnGenerationClassifierQarNC, self).__init__()
...
class QarBoostNCClassifier(ColumnGenerationClassifierQarNC):
    def __init__(self, mu=0.001, epsilon=1e-08, n_max_iterations=None, estimators_generator=None, save_iteration_as_hyperparameter_each=None, random_state=42):
        super(QarBoostNCClassifier, self).__init__(epsilon, n_max_iterations, estimators_generator, dual_constraint_rhs=0,
...
class QarBoostNC(QarBoostNCClassifier):
    ...
    def genPipeline(self):
        return Pipeline([('classifier', QarBoostNCClassifier())])
...
def fit(DATASET, CLASS_LABELS, randomState, NB_CORES=1, **kwargs):
    ...
    classifier = QarBoostNCClassifier(mu=kwargs['mu'],
                                      epsilon=kwargs['epsilon'],
                                      n_max_iterations=kwargs["n_max_iterations"],
...
def getKWARGS(args):
    """Used to format kwargs for the parsed args"""
    kwargsDict = {}
    kwargsDict['mu'] = args.QarBNC_mu
    kwargsDict['epsilon'] = args.QarBNC_epsilon
    kwargsDict['n_max_iterations'] = None
    return kwargsDict
