...
class ColumnGenerationClassifierQar2(BaseEstimator, ClassifierMixin, BaseBoost):
    def __init__(self, epsilon=1e-06, n_max_iterations=None, estimators_generator=None, dual_constraint_rhs=0, save_iteration_as_hyperparameter_each=None, random_state=42):
        super(ColumnGenerationClassifierQar2, self).__init__()
...
class QarBoostClassifierv2(ColumnGenerationClassifierQar2):
    def __init__(self, mu=0.001, epsilon=1e-08, n_max_iterations=None, estimators_generator=None, save_iteration_as_hyperparameter_each=None, random_state=42):
        super(QarBoostClassifierv2, self).__init__(epsilon, n_max_iterations, estimators_generator, dual_constraint_rhs=0,
...
class QarBoostv2(QarBoostClassifierv2):
    ...
    def genPipeline(self):
        return Pipeline([('classifier', QarBoostClassifierv2())])
...
def fit(DATASET, CLASS_LABELS, randomState, NB_CORES=1, **kwargs):
    ...
    classifier = QarBoostClassifierv2(mu=kwargs['mu'],
                                      epsilon=kwargs['epsilon'],
                                      n_max_iterations=kwargs["n_max_iterations"],
...
def getKWARGS(args):
    """Used to format kwargs for the parsed args"""
    kwargsDict = {}
    kwargsDict['mu'] = args.QarB2_mu
    kwargsDict['epsilon'] = args.QarB2_epsilon
    kwargsDict['n_max_iterations'] = None
    return kwargsDict
...
def getInterpret(classifier, directory):
    break_cause = " of multiple reasons."
    return getInterpretBase(classifier, directory, "QarBoostv2", classifier.weights_, break_cause)
