...
#         cls.assertIn("accuracy_score",res)
#         cls.assertEqual(type(res["accuracy_score"]), dict)
#         cls.assertEqual(res["accuracy_score"]["classifiersNames"], ["chicken_is_heaven-View0"])
#         cls.assertEqual(res["accuracy_score"]["trainScores"], [0.5])
#         cls.assertEqual(res["accuracy_score"]["testScores"], [0.7])
#
#
